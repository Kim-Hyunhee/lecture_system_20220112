...
def create_app():
    ...
    from .api.lectures import get_all_lectures, apply_lecture, cancel_apply, write_review, view_lecture_detail
    ...
    # 특정 강의 상세 조회
    @app.get("/lecture/<lecture_id>")  # /lecture/1   처럼 path 방식의 주소를 사용하고 싶음
